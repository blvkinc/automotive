...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Top Banner */}
      <div className="bg-primary text-center py-2 px-4 text-sm text-primary-foreground">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center space-x-2">
              <img src="/jobs.svg" alt="Automotivate Jobs" className="h-12 w-auto" />
            </Link>
          ...
          <div className="md:hidden bg-card border-t border-border">
            <div className="px-4 py-2 space-y-2">
              ...
              <div className="pt-2 border-t border-border">
                ...
                <Link
                  to="/login"
                  className="block py-2 bg-primary text-primary-foreground px-4 rounded hover:bg-opacity-90 transition-colors"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Login
                </Link>
            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-input border border-border rounded-l text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
                />
                <button className="bg-primary text-primary-foreground px-4 py-2 rounded-r hover:bg-opacity-90 transition-colors">
              ...
              <div className="flex gap-3 mt-6">
                <a href="#" className="w-8 h-8 bg-muted rounded-full flex items-center justify-center hover:bg-accent transition-colors">
